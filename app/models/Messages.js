...
module.export = new mongoose.model('Message', { //assign to module.export (allows outside access), create a new model with a new schema inside holding the data
  to: { type:mongoose.Schema.Types.ObjectId, ref: 'Users' }, // syntax for mongoose documents is name: Data type , {inside} for more tags and with each term separated by a comma
